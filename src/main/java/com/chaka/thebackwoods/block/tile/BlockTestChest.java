package com.chaka.thebackwoods.block.tile;
...
public class BlockTestChest extends BlockChest {

    private final Random field_149955_b = new Random();

    public BlockTestChest(int p_i45397_1_) {
        super(p_i45397_1_);
        this.setBlockName("testChest");
    ...
    public IInventory func_149951_m(World p_149951_1_, int p_149951_2_, int p_149951_3_, int p_149951_4_)
    {
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityTestChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(Reference.MOD_ID + ":TestChest");
    }
