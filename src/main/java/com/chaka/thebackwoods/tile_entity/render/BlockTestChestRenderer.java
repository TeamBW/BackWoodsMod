package com.chaka.thebackwoods.tile_entity.render;
    ...
    public class BlockTestChestRenderer extends TileEntitySpecialRenderer {
        ...
        public void renderTileEntityAt(TileEntityTestChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
        {
            ...
            else
            {
                ...
                if (block instanceof BlockTestChest && i == 0)
                {
                    try
                    {
                        ((BlockTestChest)block).func_149954_e(p_147500_1_.getWorldObj(), p_147500_1_.xCoord, p_147500_1_.yCoord, p_147500_1_.zCoord);
                    }
